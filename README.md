...
2. Create a virtualenv and install requirements:
   ...
   ```
3. Run training (Google Colab is recommended for faster training time) - If you already downloaded the `best_model_7classes.pth` file at first, you can skip this step.
   ```
